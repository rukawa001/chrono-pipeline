...
- **180,000** replay rows (20%): 2013/2014/2015 from part A, 2016 from part B
...
|-------|-------|-----------|------|
| Corpus PART A | Machine A 8×GPU | Yes | ~4–7 h |
| Corpus PART B | Machine B 8×GPU | Yes | ~8–12 h |
| Merge + train | This machine 1×GPU | After corpus | ~9–15 h |
| **Wall clock** | | A ∥ B | **~17–27 h** |
